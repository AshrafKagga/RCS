        ...
        <div class="content-wrapper">
            ...
            <div class="card-body pt-3" bis_skin_checked="1">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#recent-events" aria-selected="false" tabindex="-1" role="tab">Recent events</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#new-events" aria-selected="false" tabindex="-1" role="tab">New events</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#curent-events" aria-selected="false" tabindex="-1" role="tab">Current events</button>
                  </li>
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#complet-events" aria-selected="false" tabindex="-1" role="tab">Complet events</button>
                  </li>
              ...
              <div class="tab-content pt-2" bis_skin_checked="1">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="recent-events" role="tabpanel" bis_skin_checked="1">
                    
                </div>
                <!-- ===========================End recent-events=========================================== -->
                <div class="tab-pane fade pt-3" id="new-events" role="tabpanel" bis_skin_checked="1">
                ...
                <div class="tab-pane fade pt-3" id="curent-events" role="tabpanel" bis_skin_checked="1">
                ...
                <div class="tab-pane fade pt-3" id="complet-events" role="tabpanel" bis_skin_checked="1">
                    <!-- settings -->
                    <!-- complet-events -->
