            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="trasurery.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Trasurery Acount</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="card-body pt-3" bis_skin_checked="1">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#deposite" aria-selected="false" tabindex="-1" role="tab">Deposits</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#Withdraws" aria-selected="false" tabindex="-1" role="tab">Withdraws</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#settings" aria-selected="false" tabindex="-1" role="tab">Others</button>
                  </li>
              ...
              <div class="tab-content pt-2" bis_skin_checked="1">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="deposite" role="tabpanel" bis_skin_checked="1">

                </div>
                <!-- ===========================End attendence section=========================================== -->
                <div class="tab-pane fade pt-3" id="withdraws" role="tabpanel" bis_skin_checked="1">
