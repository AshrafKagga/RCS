        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Rotary Projects</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="card-body pt-3" bis_skin_checked="1">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#recent-projects" aria-selected="false" tabindex="-1" role="tab">Recent Projects</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#new-projects" aria-selected="false" tabindex="-1" role="tab">New Projects</button>
                  </li>
      
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#curent-projects" aria-selected="false" tabindex="-1" role="tab">Current Projects</button>
                  </li>
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#complet-projects" aria-selected="false" tabindex="-1" role="tab">Complet Projects</button>
                  </li>
              ...
              <div class="tab-content pt-2" bis_skin_checked="1">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="recent-projects" role="tabpanel" bis_skin_checked="1">

                </div>
                <!-- ===========================End recent-projects=========================================== -->
                <div class="tab-pane fade pt-3" id="new-projects" role="tabpanel" bis_skin_checked="1">
                ...
                <div class="tab-pane fade pt-3" id="curent-projects" role="tabpanel" bis_skin_checked="1">
